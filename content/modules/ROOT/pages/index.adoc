...
You have **7 scenarios** (Note: Adjusted count based on content provided so far, you mentioned 8 but only listed 7 scenarios in the nav) to work through, covering each major component of Ansible Automation Platform:
...
Change into your working directory and clone the lab repository containing the playbooks.
...
[.output]
====
You will be prompted to select a scenario. Select **Scenario 1** to begin the troubleshooting exercises.
====
