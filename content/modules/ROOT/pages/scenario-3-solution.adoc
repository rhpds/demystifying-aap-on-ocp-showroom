...
This page provides the detailed solutions for the issue presented in Scenario 3. Review these steps after you have attempted the diagnosis and resolution yourself.
...
After the CR modifications is applied, the Operator must reconcile the environment.
