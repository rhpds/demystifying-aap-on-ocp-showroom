...
====
**UI Method:**
1. Navigate to **Workloads** -> **Pods** and view the logs for the `automation-controller` pod for database connection errors.
2. Navigate to **Networking** -> **Services** in the OpenShift console. Check for the database service (`<scenario-name>-aap-postgres-15`).
====
