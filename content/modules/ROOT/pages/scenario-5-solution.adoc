...
In the *OpenShift Console*, navigate to *Operators → Installed Operators → Ansible Automation Platform* and open your AAP instance. Switch to the *YAML* view and modify the `spec.hub.content.resource_requirements` section:
...
In the *OpenShift Console*, navigate to *Storage → PersistentVolumeClaims* in your namespace. Find the Hub file storage PVC, open it, switch to the *YAML* view and manually change `spec.resources.requests.storage` to `10Gi`.
