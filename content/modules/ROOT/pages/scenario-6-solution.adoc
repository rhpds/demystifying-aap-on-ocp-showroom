...
In the *OpenShift Console*, navigate to *Workloads → Pods* in your namespace. Delete the `lightspeed-api` and `lightspeed-chatbot-api` pods. They will restart automatically and pick up the corrected configuration.
