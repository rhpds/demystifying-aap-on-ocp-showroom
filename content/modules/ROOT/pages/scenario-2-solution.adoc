...
Update the `spec.automationhub.storageClass` field in the `AnsibleAutomationPlatform` CR to use an RWX-compatible StorageClass available in your cluster (e.g., `ocs-external-storagecluster-cephfs`).
